                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nama_obat"  value="<?php  echo $data['nama_obat']; ?>" type="text" placeholder="Enter Nama Obat"  required="" name="nama_obat"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-user_entry"  value="<?php  echo $data['user_entry']; ?>" type="number" placeholder="Enter User Entry" step="1"  required="" name="user_entry"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
