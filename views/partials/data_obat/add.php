            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="data_obat-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("data_obat/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-user_entry"  value="<?php  echo $this->set_field_value('user_entry',""); ?>" type="number" placeholder="Enter User Entry" step="1"  required="" name="user_entry"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
