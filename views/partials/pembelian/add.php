                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-id_pembelian"  value="<?php  echo $this->set_field_value('id_pembelian',""); ?>" type="number" placeholder="Enter Id Pembelian" step="1"  required="" name="id_pembelian"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            <input id="ctrl-tgl_pembelian" class="form-control datepicker  datepicker"  required="" value="<?php  echo $this->set_field_value('tgl_pembelian',""); ?>" type="datetime" name="tgl_pembelian" placeholder="Enter Tgl Pembelian" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-kode_barang"  value="<?php  echo $this->set_field_value('kode_barang',""); ?>" type="number" placeholder="Enter Kode Barang" step="1"  required="" name="kode_barang"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <input id="ctrl-discount"  value="<?php  echo $this->set_field_value('discount',""); ?>" type="text" placeholder="Enter Discount"  required="" name="discount"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
