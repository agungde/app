                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-user_entry"  value="<?php  echo $this->set_field_value('user_entry',USER_NAME); ?>" type="text" placeholder="Enter User Entry" list="user_entry_list"  required="" name="user_entry"  class="form-control " />
                                                                        <datalist id="user_entry_list">
                                                                            <?php 
                                                                            $user_entry_options = $comp_model -> user_login_user_entry_option_list();
