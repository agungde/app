...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Role Permissions</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-role_id"  value="<?php  echo $this->set_field_value('role_id',""); ?>" type="number" placeholder="Enter Role Id" step="1"  required="" name="role_id"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-page_name"  value="<?php  echo $this->set_field_value('page_name',""); ?>" type="text" placeholder="Enter Page Name"  required="" name="page_name"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-action_name"  value="<?php  echo $this->set_field_value('action_name',""); ?>" type="text" placeholder="Enter Action Name"  required="" name="action_name"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
