...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Transaksi Clinik</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("transaksi_clinik/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <input id="ctrl-id_rekam_medis"  value="<?php  echo $data['id_rekam_medis']; ?>" type="hidden" placeholder="Enter Id Rekam Medis"  readonly required="" name="id_rekam_medis"  class="form-control " />
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-keterangan_resep"  value="<?php  echo $data['keterangan_resep']; ?>" type="text" placeholder="Enter Keterangan Resep"  readonly required="" name="keterangan_resep"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-resep_obat"  value="<?php  echo $data['resep_obat']; ?>" type="text" placeholder="Enter Resep Obat"  readonly required="" name="resep_obat"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-keterangan_tindakan"  value="<?php  echo $data['keterangan_tindakan']; ?>" type="text" placeholder="Enter Keterangan Tindakan"  readonly required="" name="keterangan_tindakan"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-biaya_tindakan"  value="<?php  echo $data['biaya_tindakan']; ?>" type="number" placeholder="Enter Biaya Tindakan" step="1"  readonly required="" name="biaya_tindakan"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <input id="ctrl-jasa_dokter"  value="<?php  echo $data['jasa_dokter']; ?>" type="text" placeholder="Enter Jasa Dokter"  readonly required="" name="jasa_dokter"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <div class="">
                                                                                        <input id="ctrl-total_biaya"  value="<?php  echo $data['total_biaya']; ?>" type="number" placeholder="Enter Total Biaya" step="1"  readonly required="" name="total_biaya"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group ">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <div class="">
                                                                                            <input id="ctrl-metode_pembayaran"  value="<?php  echo $data['metode_pembayaran']; ?>" type="text" placeholder="Enter Metode Pembayaran" list="metode_pembayaran_list"  readonly required="" name="metode_pembayaran"  class="form-control " />
                                                                                        ...
                                                                                        <div class="col-sm-8">
                                                                                            <div class="">
                                                                                                <select required=""  id="ctrl-setatus_tagihan" name="setatus_tagihan"  placeholder="Select a value ..."    class="custom-select" >
                                                                                                    ...
                                                                                                    $field_value = $data['setatus_tagihan'];
