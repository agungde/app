                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-id_pelanggan"  value="<?php  echo $this->set_field_value('id_pelanggan',""); ?>" type="number" placeholder="Enter Id Pelanggan" step="1"  required="" name="id_pelanggan"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
