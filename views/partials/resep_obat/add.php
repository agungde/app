            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="resep_obat-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("resep_obat/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-tanggal_lahir"  value="<?php  echo $this->set_field_value('tanggal_lahir',""); ?>" type="text" placeholder="Enter Tanggal Lahir"  required="" name="tanggal_lahir"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-nama_poli"  value="<?php echo $comp_model->resep_obat_nama_poli_default_value() ?>" type="text" placeholder="Enter Nama Poli" list="nama_poli_list"  required="" name="nama_poli"  class="form-control " />
                                                                        <datalist id="nama_poli_list">
                                                                            <?php 
                                                                            $nama_poli_options = $comp_model -> resep_obat_nama_poli_option_list();
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-umur"  value="<?php  echo $this->set_field_value('umur',""); ?>" type="text" placeholder="Enter Umur"  required="" name="umur"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <select required=""  id="ctrl-pembayaran" name="pembayaran"  placeholder="Select a value ..."    class="custom-select" >
                                                                                        ...
                                                                                        <?php
                                                                                        $pembayaran_options = Menu :: $setatus_tagihan;
