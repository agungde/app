                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card animated fadeIn page-content">
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-nama_bank">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['nama_bank']; ?>" 
                                                data-pk="<?php echo $data['id_databank'] ?>" 
                                                data-url="<?php print_link("data_bank/editfield/" . urlencode($data['id_databank'])); ?>" 
                                                data-name="nama_bank" 
                                                data-title="Enter Nama Bank" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
                                    ...
                                    <tr  class="td-no_rek">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['no_rek']; ?>" 
                                                data-pk="<?php echo $data['id_databank'] ?>" 
                                                data-url="<?php print_link("data_bank/editfield/" . urlencode($data['id_databank'])); ?>" 
                                                data-name="no_rek" 
                                                data-title="Enter No Rek" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
                                    ...
                                    <tr  class="td-cabang">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['cabang']; ?>" 
                                                data-pk="<?php echo $data['id_databank'] ?>" 
                                                data-url="<?php print_link("data_bank/editfield/" . urlencode($data['id_databank'])); ?>" 
                                                data-name="cabang" 
                                    ...
                                    <tr  class="td-nama_pemilik">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['nama_pemilik']; ?>" 
                                                data-pk="<?php echo $data['id_databank'] ?>" 
                                                data-url="<?php print_link("data_bank/editfield/" . urlencode($data['id_databank'])); ?>" 
                                                data-name="nama_pemilik" 
                                                data-title="Enter Nama Pemilik" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
                        ...
                        <div class="p-3 d-flex">
                            <?php if($can_edit){ ?>
                            <a class="btn btn-sm btn-info"  href="<?php print_link("data_bank/edit/$rec_id"); ?>">
                                <i class="fa fa-edit"></i> Edit
                            </a>
                            <?php } ?>
                            <?php if($can_delete){ ?>
                            <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("data_bank/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
