...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Appointment</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <form id="appointment-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("appointment/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="tanggal_appoitment">Tanggal Appoitment <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-tanggal_appoitment"  value="<?php  echo $this->set_field_value('tanggal_appoitment',""); ?>" type="text" placeholder="Enter Tanggal Appoitment"  required="" name="tanggal_appoitment"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <select required=""  id="ctrl-pembayaran" name="pembayaran"  placeholder="Select a value ..."    class="custom-select" >
                                                                    ...
                                                                    <?php
                                                                    $pembayaran_options = Menu :: $pembayaran;
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <select required=""  id="ctrl-nama_poli" data-load-path="<?php print_link('api/json/appointment_nama_poli_option_list') ?>" data-load-select-options="nama_poli" name="nama_poli"  placeholder="Select a value ..."    class="custom-select" >
                                                                        <option value="">Select a value ...</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <select required=""  id="ctrl-dokter" name="dokter"  placeholder="Select a value ..."    class="custom-select" >
                                                                        <option value="">Select a value ...</option>
                                                                        <?php 
                                                                        $dokter_options = $comp_model -> appointment_dokter_option_list();
