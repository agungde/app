                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-tanggal_appoitment"  value="<?php  echo $data['tanggal_appoitment']; ?>" type="text" placeholder="Enter Tanggal Appoitment"  required="" name="tanggal_appoitment"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <select required=""  id="ctrl-nama_poli" data-load-path="<?php print_link('api/json/appointment_nama_poli_option_list') ?>" data-load-select-options="nama_poli" name="nama_poli"  placeholder="Select a value ..."    class="custom-select" >
                                                                        <?php
                                                                        $rec = $data['nama_poli'];
                                                                        $nama_poli_options = $comp_model -> appointment_nama_poli_option_list($data['nama_poli']);
