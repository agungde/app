                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-user_entry"  value="<?php  echo $data['user_entry']; ?>" type="text" placeholder="Enter User Entry" list="user_entry_list"  required="" name="user_entry"  class="form-control " />
