                        ...
                        <form method="get" action="<?php print_link($current_page) ?>" class="form filter-form">
                            <div class="card sticky-top">
                                ...
                                <nav class="navbar navbar-expand-lg navbar-light">
                                    <div class="h4">Filter By Nama Poli</div>
                                ...
                                <div class="collapse collapse-lg " id="<?php echo $menu_id ?>">
                                    <ul class="nav nav-pills">
                                        <?php 
                                        $option_list = $comp_model->rekam_medis_rekam_medisnama_poli_option_list();
                                        if(!empty($option_list)){
                                        foreach($option_list as $option){
                                        $value = (!empty($option['value']) ? $option['value'] : null);
                                        $label = (!empty($option['label']) ? $option['label'] : $value);
                                        $nav_link = $this->set_current_page_link(array('rekam_medis_nama_poli' => $value , 'rekam_medis_nama_polilabel' => $label) , false);
                                        ?>
                                        <li class="nav-item">
                                            <a class="nav-link <?php echo is_active_link('rekam_medis_nama_poli', $value); ?>" href="<?php print_link($nav_link) ?>">
                                                <i class="fa fa-medkit "></i> <?php echo $label; ?>
                                            </a>
                                        </li>
                                        <?php
                                        }
                            ...
                            <div class="filter-tags mb-2">
                                <?php
                                if(!empty(get_value('rekam_medis_nama_poli'))){
                                ?>
                                <div class="filter-chip card bg-light">
                                    <b>Rekam Medis :</b> 
                                    <?php 
                                    if(get_value('rekam_medis_nama_polilabel')){
                                    echo get_value('rekam_medis_nama_polilabel');
                                    }
                                    else{
                                    echo get_value('rekam_medis_nama_poli');
                                    }
                                    $remove_link = unset_get_value('rekam_medis_nama_poli', $this->route->page_url);
                                    ?>
                                        ...
                                        <table class="table  table-striped table-sm text-left">
                                            <thead class="table-header bg-light">
                                                <tr>
                                                    ...
                                                    <th  class="td-nama_pemeriksaan_lab"> Nama Pemeriksaan Lab</th>
                                                    <th  class="td-keluhan"> Keluhan</th>
                                                    <th  class="td-diagnosa"> Diagnosa</th>
                                                    <th  class="td-rujukan"> Rujukan</th>
                                                    <th  class="td-resep_obat"> Resep Obat</th>
                                                    <th  class="td-persetujuan_tindakan"> Persetujuan Tindakan</th>
                                                    ...
                                                    <th  class="td-jenis_tindakan_lab"> Jenis Tindakan Lab</th>
                                                    <th class="td-btn"></th>
                                                </tr>
                                            </thead>
                                            <?php
