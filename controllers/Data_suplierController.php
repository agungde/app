...
class Data_suplierController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				data_suplier.date_update LIKE ? OR 
				data_suplier.date_updated LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("id_suplier","nama","alamat","no_hp","ketrangan","operator","date_update","date_updated");
