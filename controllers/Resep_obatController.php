...
class Resep_obatController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$fields = array("resep_obat.date_created", 
			"resep_obat.id_resep_obat", 
			"resep_obat.tanggal", 
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				resep_obat.id_pendaftaran_poli LIKE ? OR 
				resep_obat.operator LIKE ? OR 
				resep_obat.date_update LIKE ? OR 
				resep_obat.date_updated LIKE ?
			)";
			$search_params = array(
		...
		$db->join("data_poli", "resep_obat.nama_poli = data_poli.id_poli", "INNER");
...
$record['date_created'] = format_date($record['date_created'],'d-m-Y H:i:s');
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nama_pasien","alamat","tanggal_lahir","setatus","tanggal","nama_poli","umur","no_rekam_medis","nama_dokter","pembayaran","date_update");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_resep_obat","nama_pasien","alamat","tanggal_lahir","setatus","tanggal","nama_poli","umur","no_rekam_medis","nama_dokter","pembayaran","date_update");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nama_pasien' => 'required',
