...
class Jenis_pemeriksaan_labController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				jenis_pemeriksaan_lab.jenis_peeriksaan LIKE ?
			)";
			$search_params = array(
				"%$text%","%$text%"
			);
	...
	function import_data(){
		...
		$this->redirect("jenis_pemeriksaan_lab");
	}
	/**
     * View record detail 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("jenis_peeriksaan");
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'jenis_peeriksaan' => 'required',
			);
			$this->sanitize_array = array(
				'jenis_peeriksaan' => 'sanitize_string',
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","jenis_peeriksaan");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'jenis_peeriksaan' => 'required',
