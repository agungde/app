...
class Data_poliController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("data_poli.id_poli", ORDER_TYPE);
		}
		if($fieldname){
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nama_poli","quota_pasien","operator","date_update","date_updated");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_poli","nama_poli","quota_pasien","operator","date_update","date_updated");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nama_poli' => 'required',
	...
	function delete($rec_id = null){
		...
		$db->where("data_poli.id_poli", $arr_rec_id, "in");
