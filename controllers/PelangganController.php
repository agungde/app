...
class PelangganController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$page_title = $this->view->page_title = "Pelanggan Clinik";
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("id_pelanggan","nama_pelanggan","alamat","phone","date_update");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","id_pelanggan","nama_pelanggan","alamat","phone","date_update");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'id_pelanggan' => 'required|numeric',
